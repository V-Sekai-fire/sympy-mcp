...
defmodule MCP.AriaSympy.ToolHandlers do
  @moduledoc """
  ...
  def handle_tool_call("sympy_solve", args, state) do
    MCP.AriaSympy.SympyToolHandlers.handle_solve(args, state)
  end

  def handle_tool_call("sympy_simplify", args, state) do
    MCP.AriaSympy.SympyToolHandlers.handle_simplify(args, state)
  end

  def handle_tool_call("sympy_differentiate", args, state) do
    MCP.AriaSympy.SympyToolHandlers.handle_differentiate(args, state)
  end

  def handle_tool_call("sympy_integrate", args, state) do
    MCP.AriaSympy.SympyToolHandlers.handle_integrate(args, state)
  end

  def handle_tool_call("sympy_expand", args, state) do
    MCP.AriaSympy.SympyToolHandlers.handle_expand(args, state)
  end

  def handle_tool_call("sympy_factor", args, state) do
    MCP.AriaSympy.SympyToolHandlers.handle_factor(args, state)
  end

  def handle_tool_call("sympy_evaluate", args, state) do
    MCP.AriaSympy.SympyToolHandlers.handle_evaluate(args, state)
  end
